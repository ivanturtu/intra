        ...
        <form wire:submit="save" class="space-y-6">
            <div class="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div>
                    ...
                    @foreach($teamMembers as $index => $member)
                        <div class="flex gap-4 mb-2">
                            <input type="text" wire:model="teamMembers.{{ $index }}.field1" placeholder="Field 1" class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            <input type="text" wire:model="teamMembers.{{ $index }}.field2" placeholder="Field 2" class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" wire:model="inSlider" id="inSlider" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        <label for="inSlider" class="ml-2 block text-sm text-gray-700">Show in Slider</label>
                    </div>
                </div>
